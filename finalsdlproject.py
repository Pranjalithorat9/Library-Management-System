...
class Library:
	...
	def lend_book(self , name_of_taker , bookname , bookindex):
		...
		with open("lender_details_database.txt","a") as op:   #a=append it will add data anfter entering   op=variable
	...
	def return_book(self , name_of_returner , name_of_book):   #argument name of book
		...
		if match_bookdata in self.book_data:
			...
			self.booklist.append(name_of_book)   #add the return book
			with open("Return_details_database.txt","a") as rd:      #rd file name means varible
...
ges=Library(["Python","C Programming","Object Oriented Programming","Data Structures","Machine Learning","Engineering Mathematics","Digital Electronics","HTML5","Core Java ","K-Map Basics","Mechanics","Encyclopedia","Artificial Intelligence","Nested Data Science"])

def main():
	print ("\n\nWELCOME TO THE LIBRARY OF GOKHALE EDUCATION SOCIETY'S R.H. SAPAT COLLEGE OF ENGINEERING AND MANAGEMENT STUDIES , NASHIK\n")
